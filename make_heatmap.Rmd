...
#Chromobacterium|Archangium
#par(mar = c(20, 2, 1, 20))
png("heatmap_Dec2022.ChromoArchan.png", res=600, width=20, height= 15,  units='in')
h1<- heatmap.2( reordered_matrix_mat_1, 
              dendrogram = c("both"),
              trace="none",
              density.info="none",
...
#Chromobacterium|Archangium
#par(mar = c(20, 2, 1, 20))
png("heatmap_Dec2022.AquitaleaArchan.png", res=600, width=15, height= 10,  units='in')
h1<- heatmap.2( reordered_matrix_mat_1, 
              dendrogram = c("both"),
              trace="none",
              density.info="none",
...
#Chromobacterium|Archangium
#par(mar = c(20, 2, 1, 20))
png("heatmap_Dec2022.IodobacterArchan.png", res=600, width=15, height=10,  units='in')
h1<- heatmap.2( reordered_matrix_mat_1, 
              dendrogram = c("both"),
              trace="none",
              density.info="none",
...
#Chromobacterium|Archangium
#par(mar = c(20, 2, 1, 20))
png("heatmap_Dec2022.DuganellaArchan.png", res=600, width=20, height= 15,  units='in')
h1<- heatmap.2( reordered_matrix_mat_1, 
              dendrogram = c("both"),
              trace="none",
              density.info="none",
...
#Chromobacterium|Archangium
#par(mar = c(20, 2, 1, 20))
png("heatmap_Dec2022.MassiliaArchan.png", res=600, width=25, height= 18,  units='in')
h1<- heatmap.2( reordered_matrix_mat_1, 
              dendrogram = c("both"),
              trace="none",
              density.info="none",
...
#Chromobacterium|Archangium
#par(mar = c(20, 2, 1, 20))
png("heatmap_Dec2022.JanthinoArchan.png", res=600, width=26, height= 20,  units='in')
h1<- heatmap.2( reordered_matrix_mat_1, 
              dendrogram = c("both"),
              trace="none",
              density.info="none",
